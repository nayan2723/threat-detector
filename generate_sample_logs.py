...
def generate_sample_events() -> list[dict]:
    ...
    for i in range(8):
        events.append(
            {
                "event_id": 4625,
                "timestamp": (base_time + timedelta(seconds=30 * i)).strftime(
                    "%Y-%m-%dT%H:%M:%S"
                ),
        ...
        events.append(
            {
                "event_id": 4625,
                "timestamp": (
                    base_time + timedelta(minutes=20, seconds=i * 60)
    ...
    events.append(
        {
            "event_id": 4720,
            "timestamp": (base_time + timedelta(minutes=10)).strftime(
                "%Y-%m-%dT%H:%M:%S"
            ),
            "computer": "WS05.corp.local",
            "event_data": {
    ...
    events.append(
        {
            "event_id": 4732,
            "timestamp": (base_time + timedelta(minutes=11)).strftime(
                "%Y-%m-%dT%H:%M:%S"
            ),
            "computer": "WS05.corp.local",
            "event_data": {
    ...
    events.append(
        {
            "event_id": 4728,
            "timestamp": (base_time + timedelta(minutes=12)).strftime(
                "%Y-%m-%dT%H:%M:%S"
            ),
            "computer": "DC01.corp.local",
            "event_data": {
    ...
    encoded_payload = (
        "SQBuAHYAbwBrAGUALQBNAGkAbQBpAGsAYQB0AHoAIAAtAEQAdQBtAHAAQwByAGUAZABz"
    )
    events.append(
        {
            "event_id": 4688,
            "timestamp": (base_time + timedelta(minutes=15)).strftime(
                "%Y-%m-%dT%H:%M:%S"
            ),
            "computer": "WS05.corp.local",
            "event_data": {
    ...
    events.append(
        {
            "event_id": 4688,
            "timestamp": (base_time + timedelta(minutes=20)).strftime(
                "%Y-%m-%dT%H:%M:%S"
            ),
    ...
    events.append(
        {
            "event_id": 4688,
            "timestamp": (base_time + timedelta(minutes=22)).strftime(
                "%Y-%m-%dT%H:%M:%S"
            ),
            "computer": "WS12.corp.local",
            "event_data": {
